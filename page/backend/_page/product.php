  <?php
    if(isset($_GET['id']) && $_GET['id'] != NULL && $_GET['id'] != "")
    {
      ...
      if($query_f_edit_product->num_rows != 0)
      {
        ...
        if(isset($_POST['btn_edit_product']))
        {
          ...
          $sql_edit_product = 'UPDATE shop SET 
								name = "'.$_POST['product_name'].'", 
								price = "'.$_POST['product_price'].'", 
								pricerp = "'.$_POST['product_pricerp'].'", 
								priceeve = "'.$_POST['product_priceeve'].'", 
								category = "'.$_POST['product_category'].'", 
								command = "'.$_POST['product_command'].'", 
								pic = "'.$_POST['product_pic'].'", 
								server_id = "'.$bungee_edit.'"';
          ...
          <form name="edit_product" method="POST">
            <div class="row">
              <div class="col-md-6 mb-3">
                  ...
                  <div class="col-md-6 mb-3">
                      <label for="product_price">ราคา TP</label>
                      <input type="text" class="form-control" id="product_price" name="product_price" value="<?php echo $product_f['price']; ?>">
					  <label for="product_price">ราคา RP</label>
                      <input type="text" class="form-control" id="product_pricerp" name="product_pricerp" value="<?php echo $product_f['pricerp']; ?>">
					  <label for="product_price">ราคา EP</label>
                      <input type="text" class="form-control" id="product_priceeve" name="product_priceeve" value="<?php echo $product_f['priceeve']; ?>">
                  </div>
    ...
    elseif(isset($_GET['action']) && $_GET['action'] != NULL && $_GET['action'] != "" && $_GET['action'] == 'add')
    {
      if(isset($_POST['btn_add_product']))
      {
        ...
        $sql_add_product = 'INSERT INTO shop (name,price,pricerp,priceeve,category,command,pic,server_id) VALUES ("'.$_POST['product_name'].'","'.$_POST['product_price'].'","'.$_POST['product_pricerp'].'","'.$_POST['product_priceeve'].'","'.$_POST['product_category'].'","'.$_POST['product_command'].'","'.$_POST['product_pic'].'","'.$bungee_add.'")';
        ...
        <form name="add_product" method="POST">
            <div class="row">
              <div class="col-md-6 mb-3">
                  ...
                  <div class="col-md-6 mb-3">
                      <label for="product_price">ราคา TP</label>
                      <input type="text" class="form-control" id="product_price" name="product_price" required="" value="0">
					  <label for="product_price">ราคา RP</label>
                      <input type="text" class="form-control" id="product_pricerp" name="product_pricerp" required="" value="0">
					  <label for="product_price">ราคา EP</label>
                      <input type="text" class="form-control" id="product_priceeve" name="product_priceeve" required="" value="0">
                  </div>
                  <div class="col-md-4 mb-3">
                      <label for="product_category">หมวดหมู่</label>
