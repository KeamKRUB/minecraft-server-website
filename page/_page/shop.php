<div class="card border-0 shadow mb-4">
                             ...
                             <?php
                                    $sql_bungeecord = 'SELECT * FROM bungeecord';
                                      ...
                                      while($server_bungeecord = $query_bungeecord->fetch_assoc())
                                      {
                                        ...
                                        {
                                          echo '<div class="col-md-3">';
                                          echo '<a href="?page=shop&server='.$server_bungeecord['id'].'" class="btn btn-levitate btn-primary btn-block">'.$server_bungeecord['name_server'].'</a>';
                                          echo '</div>';
                                        }
                                      }
                                      echo '</div>';
            ...
            <div class="item" style="margin-bottom: 20px;">
              ...
              {
              echo $product['pricerp']; 
              echo 'RP ';
              }
              if($product['priceeve'] >= 1)
              {
              echo $product['priceeve']; 
              echo 'EP';
              }
              ?></a>
