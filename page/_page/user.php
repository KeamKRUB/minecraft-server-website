...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text lp-title-input">Point: </span>
  </div>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text lp-title-input">RealPoint (RP) : </span>
  </div>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text lp-title-input">EventPoint (EP) : </span>
  </div>
    <input type="text" name="username" disabled="" value="<?php echo number_format($player['rp']); ?>.00 พ้อยท์" id="username" class="form-control form-control-lg lp-input">
</div>
  </div>
